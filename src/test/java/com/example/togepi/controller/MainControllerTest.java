...
public class MainControllerTest {
    ...
    public void testCreateOrderSuccess() throws Exception {
        ...
        when(mainService.createOrder(order)).thenReturn(order);
    ...
    @Test
    public void testCreateOrderEmptyItem() throws Exception {
        final List<Item> items = new ArrayList<>();
        final Order order = new Order(items);
    ...
    public void testGetOrderSuccess() throws Exception {
        ...
        when(mainService.getOrderById(orderId)).thenReturn(new Order());
    ...
    public void testGetOrderNotFound() throws Exception {
        ...
        when(mainService.getOrderById(orderId)).thenThrow(new ResourceNotFoundException("Order not found"));
        this.mockMvc.perform(get("/orders/" + orderId))
