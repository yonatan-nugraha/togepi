        ...
        return httpClient.prepareGet(BASE_URL + "/restaurant?res_id=17842104")
                ...
                .execute(new AsyncCompletionHandler<ZomatoResponse>() {
                    ...
                    public ZomatoResponse onCompleted(Response response) throws Exception {
                        ...
                        if (isSuccess) {
                            final ZomatoResponse zomatoResponse = mapper.readValue(responseBody, ZomatoResponse.class);
                            return zomatoResponse;
                        } else {
                            final ZomatoErrorResponse zomatoErrorResponse = mapper.readValue(responseBody, ZomatoErrorResponse.class);
